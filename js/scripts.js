$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbzX3L2OKnTTK1TibH5QrVkoao8b_OqtFPr_dOvuw4l376zcHt3RkzJ6d1avU4kyzEaXSg/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 3.17678, lng: 101.68732};
